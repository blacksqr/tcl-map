...
SWIGEXPORT void Init_osr(void) {
  ...
  rb_define_const(mOsr, "SRS_PT_GAUSSSCHREIBERTMERCATOR", SWIG_FromCharPtr(SRS_PT_GAUSSSCHREIBERTMERCATOR));
  ...
  rb_define_method(cSpatialReference.klass, "set_authority", VALUEFUNC(_wrap_SpatialReference_set_authority), -1);
  ...
  rb_define_method(cSpatialReference.klass, "set_linear_units_and_update_parameters", VALUEFUNC(_wrap_SpatialReference_set_linear_units_and_update_parameters), -1);
  ...
  rb_define_method(cSpatialReference.klass, "set_cea", VALUEFUNC(_wrap_SpatialReference_set_cea), -1);
  ...
  rb_define_method(cSpatialReference.klass, "set_equirectangular2", VALUEFUNC(_wrap_SpatialReference_set_equirectangular2), -1);
  rb_define_method(cSpatialReference.klass, "set_gauss_schreiber_tmercator", VALUEFUNC(_wrap_SpatialReference_set_gauss_schreiber_tmercator), -1);
  rb_define_method(cSpatialReference.klass, "set_gs", VALUEFUNC(_wrap_SpatialReference_set_gs), -1);
  rb_define_method(cSpatialReference.klass, "set_gh", VALUEFUNC(_wrap_SpatialReference_set_gh), -1);
  rb_define_method(cSpatialReference.klass, "set_geos", VALUEFUNC(_wrap_SpatialReference_set_geos), -1);
  rb_define_method(cSpatialReference.klass, "set_gnomonic", VALUEFUNC(_wrap_SpatialReference_set_gnomonic), -1);
  rb_define_method(cSpatialReference.klass, "set_hom", VALUEFUNC(_wrap_SpatialReference_set_hom), -1);
  rb_define_method(cSpatialReference.klass, "set_hom_2pno", VALUEFUNC(_wrap_SpatialReference_set_hom_2pno), -1);
  rb_define_method(cSpatialReference.klass, "set_krovak", VALUEFUNC(_wrap_SpatialReference_set_krovak), -1);
  rb_define_method(cSpatialReference.klass, "set_laea", VALUEFUNC(_wrap_SpatialReference_set_laea), -1);
  rb_define_method(cSpatialReference.klass, "set_lcc", VALUEFUNC(_wrap_SpatialReference_set_lcc), -1);
  rb_define_method(cSpatialReference.klass, "set_lcc_1sp", VALUEFUNC(_wrap_SpatialReference_set_lcc_1sp), -1);
  rb_define_method(cSpatialReference.klass, "set_lccb", VALUEFUNC(_wrap_SpatialReference_set_lccb), -1);
  rb_define_method(cSpatialReference.klass, "set_mc", VALUEFUNC(_wrap_SpatialReference_set_mc), -1);
  rb_define_method(cSpatialReference.klass, "set_mercator", VALUEFUNC(_wrap_SpatialReference_set_mercator), -1);
  rb_define_method(cSpatialReference.klass, "set_mollweide", VALUEFUNC(_wrap_SpatialReference_set_mollweide), -1);
  rb_define_method(cSpatialReference.klass, "set_nzmg", VALUEFUNC(_wrap_SpatialReference_set_nzmg), -1);
  rb_define_method(cSpatialReference.klass, "set_os", VALUEFUNC(_wrap_SpatialReference_set_os), -1);
  rb_define_method(cSpatialReference.klass, "set_orthographic", VALUEFUNC(_wrap_SpatialReference_set_orthographic), -1);
  rb_define_method(cSpatialReference.klass, "set_polyconic", VALUEFUNC(_wrap_SpatialReference_set_polyconic), -1);
  rb_define_method(cSpatialReference.klass, "set_ps", VALUEFUNC(_wrap_SpatialReference_set_ps), -1);
  rb_define_method(cSpatialReference.klass, "set_robinson", VALUEFUNC(_wrap_SpatialReference_set_robinson), -1);
  rb_define_method(cSpatialReference.klass, "set_sinusoidal", VALUEFUNC(_wrap_SpatialReference_set_sinusoidal), -1);
  rb_define_method(cSpatialReference.klass, "set_stereographic", VALUEFUNC(_wrap_SpatialReference_set_stereographic), -1);
  rb_define_method(cSpatialReference.klass, "set_soc", VALUEFUNC(_wrap_SpatialReference_set_soc), -1);
  rb_define_method(cSpatialReference.klass, "set_tm", VALUEFUNC(_wrap_SpatialReference_set_tm), -1);
  rb_define_method(cSpatialReference.klass, "set_tmvariant", VALUEFUNC(_wrap_SpatialReference_set_tmvariant), -1);
  rb_define_method(cSpatialReference.klass, "set_tmg", VALUEFUNC(_wrap_SpatialReference_set_tmg), -1);
  rb_define_method(cSpatialReference.klass, "set_tmso", VALUEFUNC(_wrap_SpatialReference_set_tmso), -1);
  rb_define_method(cSpatialReference.klass, "set_vdg", VALUEFUNC(_wrap_SpatialReference_set_vdg), -1);
  ...
  rb_define_method(cSpatialReference.klass, "set_local_cs", VALUEFUNC(_wrap_SpatialReference_set_local_cs), -1);
  ...
  rb_define_method(cSpatialReference.klass, "import_from_proj4", VALUEFUNC(_wrap_SpatialReference_import_from_proj4), -1);
  rb_define_method(cSpatialReference.klass, "import_from_url", VALUEFUNC(_wrap_SpatialReference_import_from_url), -1);
  ...
  rb_define_method(cSpatialReference.klass, "import_from_micoord_sys", VALUEFUNC(_wrap_SpatialReference_import_from_micoord_sys), -1);
  ...
  rb_define_method(cSpatialReference.klass, "export_to_proj4", VALUEFUNC(_wrap_SpatialReference_export_to_proj4), -1);
  ...
  rb_define_method(cSpatialReference.klass, "export_to_micoord_sys", VALUEFUNC(_wrap_SpatialReference_export_to_micoord_sys), -1);
  ...
  rb_define_method(cCoordinateTransformation.klass, "transform_points", VALUEFUNC(_wrap_CoordinateTransformation_transform_points), -1);
