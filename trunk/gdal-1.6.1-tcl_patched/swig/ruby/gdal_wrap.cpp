...
_wrap_get_config_option(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","CPLGetConfigOption", 1, argv[0] ));
  }
  arg1 = reinterpret_cast< char * >(buf1);
  res2 = SWIG_AsCharPtrAndSize(argv[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","CPLGetConfigOption", 2, argv[1] ));
  }
  arg2 = reinterpret_cast< char * >(buf2);
  {
    CPLErrorReset();
...
_wrap_Driver_create_copy(int argc, VALUE *argv, VALUE self) {
  ...
  int res7 ;
  char *kwnames[] = {
    "self","name","src","strict","options","callback","callback_data", NULL 
  };
  GDALDatasetShadow *result = 0 ;
  VALUE vresult = Qnil;
...
_wrap_Dataset_read_raster(int argc, VALUE *argv, VALUE self) {
  ...
  int res10 = 0 ;
  char *kwnames[] = {
    "self","xoff","yoff","xsize","ysize","buf_xsize","buf_ysize","buf_type","band_list", NULL 
  };
  CPLErr result;
  VALUE vresult = Qnil;
...
swig_class cRasterAttributeTable;
...
_wrap_regenerate_overviews(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 3) {
    res4 = SWIG_AsCharPtrAndSize(argv[3], &buf4, NULL, &alloc4);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "char *","RegenerateOverviews", 4, argv[3] ));
    }
    arg4 = reinterpret_cast< char * >(buf4);
  }
  if (argc > 4) {
...
_wrap_regenerate_overview(int argc, VALUE *argv, VALUE self) {
  ...
  res3 = SWIG_AsCharPtrAndSize(argv[2], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "char *","RegenerateOverview", 3, argv[2] ));
  }
  arg3 = reinterpret_cast< char * >(buf3);
  if (argc > 3) {
    {
...
_wrap_set_cache_max(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","GDALSetCacheMax", 1, argv[0] ));
  } 
...
SWIGEXPORT void Init_gdal(void) {
  ...
  rb_define_method(cMajorObject.klass, "get_metadata_item", VALUEFUNC(_wrap_MajorObject_get_metadata_item), -1);
  rb_define_method(cMajorObject.klass, "set_metadata_item", VALUEFUNC(_wrap_MajorObject_set_metadata_item), -1);
  cMajorObject.mark = 0;
  ...
  rb_define_method(cDriver.klass, "rename", VALUEFUNC(_wrap_Driver_rename), -1);
  ...
  cColorEntry.klass = rb_define_class_under(mGdal, "ColorEntry", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_GDALColorEntry, (void *) &cColorEntry);
  rb_define_alloc_func(cColorEntry.klass, _wrap_ColorEntry_allocate);
  rb_define_method(cColorEntry.klass, "initialize", VALUEFUNC(_wrap_new_ColorEntry), -1);
  rb_define_method(cColorEntry.klass, "c1=", VALUEFUNC(_wrap_ColorEntry_c1_set), -1);
  rb_define_method(cColorEntry.klass, "c1", VALUEFUNC(_wrap_ColorEntry_c1_get), -1);
  rb_define_method(cColorEntry.klass, "c2=", VALUEFUNC(_wrap_ColorEntry_c2_set), -1);
  rb_define_method(cColorEntry.klass, "c2", VALUEFUNC(_wrap_ColorEntry_c2_get), -1);
  rb_define_method(cColorEntry.klass, "c3=", VALUEFUNC(_wrap_ColorEntry_c3_set), -1);
  rb_define_method(cColorEntry.klass, "c3", VALUEFUNC(_wrap_ColorEntry_c3_get), -1);
  rb_define_method(cColorEntry.klass, "c4=", VALUEFUNC(_wrap_ColorEntry_c4_set), -1);
  rb_define_method(cColorEntry.klass, "c4", VALUEFUNC(_wrap_ColorEntry_c4_get), -1);
  cColorEntry.mark = 0;
  cColorEntry.destroy = (void (*)(void *)) free_GDALColorEntry;
  cColorEntry.trackObjects = 0;
  ...
  rb_define_method(cDataset.klass, "create_mask_band", VALUEFUNC(_wrap_Dataset_create_mask_band), -1);
  rb_define_method(cDataset.klass, "get_file_list", VALUEFUNC(_wrap_Dataset_get_file_list), -1);
  rb_define_method(cDataset.klass, "write_raster", VALUEFUNC(_wrap_Dataset_write_raster), -1);
  rb_define_method(cDataset.klass, "read_raster", VALUEFUNC(_wrap_Dataset_read_raster), -1);
  cDataset.mark = 0;
  ...
  rb_define_method(cBand.klass, "get_block_size", VALUEFUNC(_wrap_Band_get_block_size), -1);
  ...
  rb_define_method(cBand.klass, "get_raster_category_names", VALUEFUNC(_wrap_Band_get_raster_category_names), -1);
  rb_define_method(cBand.klass, "set_raster_category_names", VALUEFUNC(_wrap_Band_set_raster_category_names), -1);
  ...
  rb_define_method(cBand.klass, "get_statistics", VALUEFUNC(_wrap_Band_get_statistics), -1);
  rb_define_method(cBand.klass, "set_statistics", VALUEFUNC(_wrap_Band_set_statistics), -1);
  ...
  rb_define_method(cBand.klass, "compute_band_stats", VALUEFUNC(_wrap_Band_compute_band_stats), -1);
  ...
  rb_define_method(cBand.klass, "get_color_table", VALUEFUNC(_wrap_Band_get_color_table), -1);
  rb_define_method(cBand.klass, "set_raster_color_table", VALUEFUNC(_wrap_Band_set_raster_color_table), -1);
  rb_define_method(cBand.klass, "set_color_table", VALUEFUNC(_wrap_Band_set_color_table), -1);
  rb_define_method(cBand.klass, "get_default_rat", VALUEFUNC(_wrap_Band_get_default_rat), -1);
  rb_define_method(cBand.klass, "set_default_rat", VALUEFUNC(_wrap_Band_set_default_rat), -1);
  rb_define_method(cBand.klass, "get_mask_band", VALUEFUNC(_wrap_Band_get_mask_band), -1);
  rb_define_method(cBand.klass, "get_mask_flags", VALUEFUNC(_wrap_Band_get_mask_flags), -1);
  rb_define_method(cBand.klass, "create_mask_band", VALUEFUNC(_wrap_Band_create_mask_band), -1);
  rb_define_method(cBand.klass, "get_histogram", VALUEFUNC(_wrap_Band_get_histogram), -1);
  rb_define_method(cBand.klass, "get_default_histogram", VALUEFUNC(_wrap_Band_get_default_histogram), -1);
  rb_define_method(cBand.klass, "set_default_histogram", VALUEFUNC(_wrap_Band_set_default_histogram), -1);
  cBand.mark = 0;
  cBand.trackObjects = 0;
  
  cColorTable.klass = rb_define_class_under(mGdal, "ColorTable", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_GDALColorTableShadow, (void *) &cColorTable);
  ...
  rb_define_method(cColorTable.klass, "create_color_ramp", VALUEFUNC(_wrap_ColorTable_create_color_ramp), -1);
  cColorTable.mark = 0;
  cColorTable.destroy = (void (*)(void *)) free_GDALColorTableShadow;
  cColorTable.trackObjects = 0;
  
  cRasterAttributeTable.klass = rb_define_class_under(mGdal, "RasterAttributeTable", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_GDALRasterAttributeTableShadow, (void *) &cRasterAttributeTable);
  rb_define_alloc_func(cRasterAttributeTable.klass, _wrap_RasterAttributeTable_allocate);
  rb_define_method(cRasterAttributeTable.klass, "initialize", VALUEFUNC(_wrap_new_RasterAttributeTable), -1);
  rb_define_method(cRasterAttributeTable.klass, "clone", VALUEFUNC(_wrap_RasterAttributeTable_clone), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_column_count", VALUEFUNC(_wrap_RasterAttributeTable_get_column_count), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_name_of_col", VALUEFUNC(_wrap_RasterAttributeTable_get_name_of_col), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_usage_of_col", VALUEFUNC(_wrap_RasterAttributeTable_get_usage_of_col), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_type_of_col", VALUEFUNC(_wrap_RasterAttributeTable_get_type_of_col), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_col_of_usage", VALUEFUNC(_wrap_RasterAttributeTable_get_col_of_usage), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_row_count", VALUEFUNC(_wrap_RasterAttributeTable_get_row_count), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_value_as_string", VALUEFUNC(_wrap_RasterAttributeTable_get_value_as_string), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_value_as_int", VALUEFUNC(_wrap_RasterAttributeTable_get_value_as_int), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_value_as_double", VALUEFUNC(_wrap_RasterAttributeTable_get_value_as_double), -1);
  rb_define_method(cRasterAttributeTable.klass, "set_value_as_string", VALUEFUNC(_wrap_RasterAttributeTable_set_value_as_string), -1);
  rb_define_method(cRasterAttributeTable.klass, "set_value_as_int", VALUEFUNC(_wrap_RasterAttributeTable_set_value_as_int), -1);
  rb_define_method(cRasterAttributeTable.klass, "set_value_as_double", VALUEFUNC(_wrap_RasterAttributeTable_set_value_as_double), -1);
  rb_define_method(cRasterAttributeTable.klass, "set_row_count", VALUEFUNC(_wrap_RasterAttributeTable_set_row_count), -1);
  rb_define_method(cRasterAttributeTable.klass, "create_column", VALUEFUNC(_wrap_RasterAttributeTable_create_column), -1);
  rb_define_method(cRasterAttributeTable.klass, "get_row_of_value", VALUEFUNC(_wrap_RasterAttributeTable_get_row_of_value), -1);
  cRasterAttributeTable.mark = 0;
  cRasterAttributeTable.destroy = (void (*)(void *)) free_GDALRasterAttributeTableShadow;
  cRasterAttributeTable.trackObjects = 0;
  ...
  cTransformer.klass = rb_define_class_under(mGdal, "Transformer", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_GDALTransformerInfoShadow, (void *) &cTransformer);
  rb_define_alloc_func(cTransformer.klass, _wrap_Transformer_allocate);
  rb_define_method(cTransformer.klass, "initialize", VALUEFUNC(_wrap_new_Transformer), -1);
  rb_define_method(cTransformer.klass, "transform_point", VALUEFUNC(_wrap_Transformer_transform_point), -1);
  rb_define_method(cTransformer.klass, "transform_points", VALUEFUNC(_wrap_Transformer_transform_points), -1);
  cTransformer.mark = 0;
  cTransformer.destroy = (void (*)(void *)) free_GDALTransformerInfoShadow;
  cTransformer.trackObjects = 0;
