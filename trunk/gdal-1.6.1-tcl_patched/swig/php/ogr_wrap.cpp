...
ZEND_NAMED_FUNCTION(_wrap_Driver_CreateDataSource) {
  ...
  }
  {
    ...
    *_cPtr = *return_value;
    ...
    object_init_ex(return_value,ptr_ce_swig_DataSource);
...
ZEND_NAMED_FUNCTION(_wrap_DataSource_CreateLayer) {
  ...
  }
  {
    ...
    *_cPtr = *return_value;
    INIT_ZVAL(*return_value);
    object_init_ex(return_value,ptr_ce_swig_Layer);
    add_property_zval(return_value,"_cPtr",_cPtr);
  }
  {
    /* %typemap(freearg) char **options */
...
ZEND_NAMED_FUNCTION(_wrap_Layer_GetSpatialFilter) {
  ...
  }
  {
    ...
    *_cPtr = *return_value;
    INIT_ZVAL(*return_value);
    object_init_ex(return_value,ptr_ce_swig_Geometry);
    add_property_zval(return_value,"_cPtr",_cPtr);
  }
  return;
fail:
...
ZEND_NAMED_FUNCTION(_wrap_Layer_GetFeature) {
  ...
  }
  {
    ...
    *_cPtr = *return_value;
    INIT_ZVAL(*return_value);
    object_init_ex(return_value,ptr_ce_swig_Feature);
    add_property_zval(return_value,"_cPtr",_cPtr);
  }
  return;
fail:
...
ZEND_NAMED_FUNCTION(_wrap_Layer_GetLayerDefn) {
  ...
  }
  {
    ...
    *_cPtr = *return_value;
    INIT_ZVAL(*return_value);
    object_init_ex(return_value,ptr_ce_swig_FeatureDefn);
    add_property_zval(return_value,"_cPtr",_cPtr);
  }
  return;
fail:
...
ZEND_NAMED_FUNCTION(_wrap_Feature_Clone) {
  ...
  {
    if(SWIG_ConvertPtr(*&this_ptr, (void **) &arg1, SWIGTYPE_p_OGRFeatureShadow, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Feature_Clone. Expected SWIGTYPE_p_OGRFeatureShadow");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Feature_GetFieldDefnRef__SWIG_0) {
  ...
  }
  {
    ...
    *_cPtr = *return_value;
    INIT_ZVAL(*return_value);
    object_init_ex(return_value,ptr_ce_swig_FieldDefn);
    add_property_zval(return_value,"_cPtr",_cPtr);
  }
  return;
fail:
...
ZEND_NAMED_FUNCTION(_wrap_Feature_GetFieldAsIntegerList) {
  ...
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg3, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 3 of Feature_GetFieldAsIntegerList. Expected SWIGTYPE_p_int");
    }
  }
  {
    if(SWIG_ConvertPtr(*args[2], (void **) &arg4, SWIGTYPE_p_p_int, 0) < 0) {
...
ZEND_NAMED_FUNCTION(_wrap_Feature_GetFieldAsDoubleList) {
  ...
  {
    if(SWIG_ConvertPtr(*args[2], (void **) &arg4, SWIGTYPE_p_p_double, 0) < 0) {
...
ZEND_NAMED_FUNCTION(_wrap_Feature_GetFieldAsStringList) {
  ...
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg3, SWIGTYPE_p_p_p_char, 0) < 0) {
...
ZEND_NAMED_FUNCTION(_wrap_Feature_SetField__SWIG_6) {
  ...
  arg8 = (int) Z_LVAL_PP(args[6]);
  /*@SWIG@*/;
  
  
  /*@SWIG:/usr/share/swig/1.3.36/php4/utils.i,7,CONVERT_INT_IN@*/
  convert_to_long_ex(args[7]);
  arg9 = (int) Z_LVAL_PP(args[7]);
  /*@SWIG@*/;
...
ZEND_NAMED_FUNCTION(_wrap_Geometry_Clone) {
  ...
  {
    if(SWIG_ConvertPtr(*&this_ptr, (void **) &arg1, SWIGTYPE_p_OGRGeometryShadow, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Geometry_Clone. Expected SWIGTYPE_p_OGRGeometryShadow");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Geometry_Empty) {
  ...
  {
    if(SWIG_ConvertPtr(*&this_ptr, (void **) &arg1, SWIGTYPE_p_OGRGeometryShadow, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Geometry_Empty. Expected SWIGTYPE_p_OGRGeometryShadow");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static zend_function_entry Driver_functions[] = {
 SWIG_ZEND_NAMED_FE(createdatasource,_wrap_Driver_CreateDataSource,NULL)
 SWIG_ZEND_NAMED_FE(copydatasource,_wrap_Driver_CopyDataSource,NULL)
 SWIG_ZEND_NAMED_FE(open,_wrap_Driver_Open,NULL)
 SWIG_ZEND_NAMED_FE(deletedatasource,_wrap_Driver_DeleteDataSource,NULL)
 SWIG_ZEND_NAMED_FE(testcapability,_wrap_Driver_TestCapability,NULL)
 SWIG_ZEND_NAMED_FE(getname,_wrap_Driver_GetName,NULL)
 { NULL, NULL, NULL}
};
/* Function entries for DataSource */
static zend_function_entry DataSource_functions[] = {
 SWIG_ZEND_NAMED_FE(getrefcount,_wrap_DataSource_GetRefCount,NULL)
 SWIG_ZEND_NAMED_FE(getsummaryrefcount,_wrap_DataSource_GetSummaryRefCount,NULL)
 SWIG_ZEND_NAMED_FE(getlayercount,_wrap_DataSource_GetLayerCount,NULL)
 SWIG_ZEND_NAMED_FE(getdriver,_wrap_DataSource_GetDriver,NULL)
 SWIG_ZEND_NAMED_FE(getname,_wrap_DataSource_GetName,NULL)
 SWIG_ZEND_NAMED_FE(deletelayer,_wrap_DataSource_DeleteLayer,NULL)
 SWIG_ZEND_NAMED_FE(createlayer,_wrap_DataSource_CreateLayer,NULL)
 SWIG_ZEND_NAMED_FE(copylayer,_wrap_DataSource_CopyLayer,NULL)
 SWIG_ZEND_NAMED_FE(getlayerbyindex,_wrap_DataSource_GetLayerByIndex,NULL)
 SWIG_ZEND_NAMED_FE(getlayerbyname,_wrap_DataSource_GetLayerByName,NULL)
 SWIG_ZEND_NAMED_FE(testcapability,_wrap_DataSource_TestCapability,NULL)
 SWIG_ZEND_NAMED_FE(executesql,_wrap_DataSource_ExecuteSQL,NULL)
 SWIG_ZEND_NAMED_FE(releaseresultset,_wrap_DataSource_ReleaseResultSet,NULL)
 { NULL, NULL, NULL}
};
/* Function entries for Layer */
static zend_function_entry Layer_functions[] = {
 SWIG_ZEND_NAMED_FE(getrefcount,_wrap_Layer_GetRefCount,NULL)
 SWIG_ZEND_NAMED_FE(setspatialfilter,_wrap_Layer_SetSpatialFilter,NULL)
 SWIG_ZEND_NAMED_FE(setspatialfilterrect,_wrap_Layer_SetSpatialFilterRect,NULL)
 SWIG_ZEND_NAMED_FE(getspatialfilter,_wrap_Layer_GetSpatialFilter,NULL)
 SWIG_ZEND_NAMED_FE(setattributefilter,_wrap_Layer_SetAttributeFilter,NULL)
 SWIG_ZEND_NAMED_FE(resetreading,_wrap_Layer_ResetReading,NULL)
 SWIG_ZEND_NAMED_FE(getname,_wrap_Layer_GetName,NULL)
 SWIG_ZEND_NAMED_FE(getgeometrycolumn,_wrap_Layer_GetGeometryColumn,NULL)
 SWIG_ZEND_NAMED_FE(getfidcolumn,_wrap_Layer_GetFIDColumn,NULL)
 SWIG_ZEND_NAMED_FE(getfeature,_wrap_Layer_GetFeature,NULL)
 SWIG_ZEND_NAMED_FE(getnextfeature,_wrap_Layer_GetNextFeature,NULL)
 SWIG_ZEND_NAMED_FE(setnextbyindex,_wrap_Layer_SetNextByIndex,NULL)
 SWIG_ZEND_NAMED_FE(setfeature,_wrap_Layer_SetFeature,NULL)
 SWIG_ZEND_NAMED_FE(createfeature,_wrap_Layer_CreateFeature,NULL)
 SWIG_ZEND_NAMED_FE(deletefeature,_wrap_Layer_DeleteFeature,NULL)
 SWIG_ZEND_NAMED_FE(synctodisk,_wrap_Layer_SyncToDisk,NULL)
 SWIG_ZEND_NAMED_FE(getlayerdefn,_wrap_Layer_GetLayerDefn,NULL)
 SWIG_ZEND_NAMED_FE(getfeaturecount,_wrap_Layer_GetFeatureCount,NULL)
 SWIG_ZEND_NAMED_FE(getextent,_wrap_Layer_GetExtent,NULL)
 SWIG_ZEND_NAMED_FE(testcapability,_wrap_Layer_TestCapability,NULL)
 SWIG_ZEND_NAMED_FE(createfield,_wrap_Layer_CreateField,NULL)
 SWIG_ZEND_NAMED_FE(starttransaction,_wrap_Layer_StartTransaction,NULL)
 SWIG_ZEND_NAMED_FE(committransaction,_wrap_Layer_CommitTransaction,NULL)
 SWIG_ZEND_NAMED_FE(rollbacktransaction,_wrap_Layer_RollbackTransaction,NULL)
 SWIG_ZEND_NAMED_FE(getspatialref,_wrap_Layer_GetSpatialRef,NULL)
 SWIG_ZEND_NAMED_FE(getfeaturesread,_wrap_Layer_GetFeaturesRead,NULL)
 { NULL, NULL, NULL}
};
/* Function entries for Feature */
static zend_function_entry Feature_functions[] = {
 SWIG_ZEND_NAMED_FE(feature,_wrap_new_Feature,NULL)
 SWIG_ZEND_NAMED_FE(getdefnref,_wrap_Feature_GetDefnRef,NULL)
 SWIG_ZEND_NAMED_FE(setgeometry,_wrap_Feature_SetGeometry,NULL)
 SWIG_ZEND_NAMED_FE(setgeometrydirectly,_wrap_Feature_SetGeometryDirectly,NULL)
 SWIG_ZEND_NAMED_FE(getgeometryref,_wrap_Feature_GetGeometryRef,NULL)
 SWIG_ZEND_NAMED_FE(clone,_wrap_Feature_Clone,NULL)
 SWIG_ZEND_NAMED_FE(equal,_wrap_Feature_Equal,NULL)
 SWIG_ZEND_NAMED_FE(getfieldcount,_wrap_Feature_GetFieldCount,NULL)
 SWIG_ZEND_NAMED_FE(getfielddefnref,_wrap_Feature_GetFieldDefnRef,NULL)
 SWIG_ZEND_NAMED_FE(getfieldasstring,_wrap_Feature_GetFieldAsString,NULL)
 SWIG_ZEND_NAMED_FE(getfieldasinteger,_wrap_Feature_GetFieldAsInteger,NULL)
 SWIG_ZEND_NAMED_FE(getfieldasdouble,_wrap_Feature_GetFieldAsDouble,NULL)
 SWIG_ZEND_NAMED_FE(getfieldasdatetime,_wrap_Feature_GetFieldAsDateTime,NULL)
 SWIG_ZEND_NAMED_FE(getfieldasintegerlist,_wrap_Feature_GetFieldAsIntegerList,NULL)
 SWIG_ZEND_NAMED_FE(getfieldasdoublelist,_wrap_Feature_GetFieldAsDoubleList,NULL)
 SWIG_ZEND_NAMED_FE(getfieldasstringlist,_wrap_Feature_GetFieldAsStringList,NULL)
 SWIG_ZEND_NAMED_FE(isfieldset,_wrap_Feature_IsFieldSet,NULL)
 SWIG_ZEND_NAMED_FE(getfieldindex,_wrap_Feature_GetFieldIndex,NULL)
 SWIG_ZEND_NAMED_FE(getfid,_wrap_Feature_GetFID,NULL)
 SWIG_ZEND_NAMED_FE(setfid,_wrap_Feature_SetFID,NULL)
 SWIG_ZEND_NAMED_FE(dumpreadable,_wrap_Feature_DumpReadable,NULL)
 SWIG_ZEND_NAMED_FE(unsetfield,_wrap_Feature_UnsetField,NULL)
 SWIG_ZEND_NAMED_FE(setfield,_wrap_Feature_SetField,NULL)
 SWIG_ZEND_NAMED_FE(setfieldintegerlist,_wrap_Feature_SetFieldIntegerList,NULL)
 SWIG_ZEND_NAMED_FE(setfielddoublelist,_wrap_Feature_SetFieldDoubleList,NULL)
 SWIG_ZEND_NAMED_FE(setfieldstringlist,_wrap_Feature_SetFieldStringList,NULL)
 SWIG_ZEND_NAMED_FE(setfrom,_wrap_Feature_SetFrom,NULL)
 SWIG_ZEND_NAMED_FE(getstylestring,_wrap_Feature_GetStyleString,NULL)
 SWIG_ZEND_NAMED_FE(setstylestring,_wrap_Feature_SetStyleString,NULL)
 SWIG_ZEND_NAMED_FE(getfieldtype,_wrap_Feature_GetFieldType,NULL)
 { NULL, NULL, NULL}
};
/* Function entries for FeatureDefn */
static zend_function_entry FeatureDefn_functions[] = {
 SWIG_ZEND_NAMED_FE(featuredefn,_wrap_new_FeatureDefn,NULL)
 SWIG_ZEND_NAMED_FE(getname,_wrap_FeatureDefn_GetName,NULL)
 SWIG_ZEND_NAMED_FE(getfieldcount,_wrap_FeatureDefn_GetFieldCount,NULL)
 SWIG_ZEND_NAMED_FE(getfielddefn,_wrap_FeatureDefn_GetFieldDefn,NULL)
 SWIG_ZEND_NAMED_FE(getfieldindex,_wrap_FeatureDefn_GetFieldIndex,NULL)
 SWIG_ZEND_NAMED_FE(addfielddefn,_wrap_FeatureDefn_AddFieldDefn,NULL)
 SWIG_ZEND_NAMED_FE(getgeomtype,_wrap_FeatureDefn_GetGeomType,NULL)
 SWIG_ZEND_NAMED_FE(setgeomtype,_wrap_FeatureDefn_SetGeomType,NULL)
 SWIG_ZEND_NAMED_FE(getreferencecount,_wrap_FeatureDefn_GetReferenceCount,NULL)
 { NULL, NULL, NULL}
};
/* Function entries for FieldDefn */
static zend_function_entry FieldDefn_functions[] = {
 SWIG_ZEND_NAMED_FE(fielddefn,_wrap_new_FieldDefn,NULL)
 SWIG_ZEND_NAMED_FE(getname,_wrap_FieldDefn_GetName,NULL)
 SWIG_ZEND_NAMED_FE(getnameref,_wrap_FieldDefn_GetNameRef,NULL)
 SWIG_ZEND_NAMED_FE(setname,_wrap_FieldDefn_SetName,NULL)
 SWIG_ZEND_NAMED_FE(gettype,_wrap_FieldDefn_GetType,NULL)
 SWIG_ZEND_NAMED_FE(settype,_wrap_FieldDefn_SetType,NULL)
 SWIG_ZEND_NAMED_FE(getjustify,_wrap_FieldDefn_GetJustify,NULL)
 SWIG_ZEND_NAMED_FE(setjustify,_wrap_FieldDefn_SetJustify,NULL)
 SWIG_ZEND_NAMED_FE(getwidth,_wrap_FieldDefn_GetWidth,NULL)
 SWIG_ZEND_NAMED_FE(setwidth,_wrap_FieldDefn_SetWidth,NULL)
 SWIG_ZEND_NAMED_FE(getprecision,_wrap_FieldDefn_GetPrecision,NULL)
 SWIG_ZEND_NAMED_FE(setprecision,_wrap_FieldDefn_SetPrecision,NULL)
 SWIG_ZEND_NAMED_FE(getfieldtypename,_wrap_FieldDefn_GetFieldTypeName,NULL)
 { NULL, NULL, NULL}
};
/* Function entries for Geometry */
static zend_function_entry Geometry_functions[] = {
 SWIG_ZEND_NAMED_FE(geometry,_wrap_new_Geometry,NULL)
 SWIG_ZEND_NAMED_FE(exporttowkt,_wrap_Geometry_ExportToWkt,NULL)
 SWIG_ZEND_NAMED_FE(exporttowkb,_wrap_Geometry_ExportToWkb,NULL)
 SWIG_ZEND_NAMED_FE(exporttogml,_wrap_Geometry_ExportToGML,NULL)
 SWIG_ZEND_NAMED_FE(exporttokml,_wrap_Geometry_ExportToKML,NULL)
 SWIG_ZEND_NAMED_FE(exporttojson,_wrap_Geometry_ExportToJson,NULL)
 SWIG_ZEND_NAMED_FE(addpoint,_wrap_Geometry_AddPoint,NULL)
 SWIG_ZEND_NAMED_FE(addpoint_2d,_wrap_Geometry_AddPoint_2D,NULL)
 SWIG_ZEND_NAMED_FE(addgeometrydirectly,_wrap_Geometry_AddGeometryDirectly,NULL)
 SWIG_ZEND_NAMED_FE(addgeometry,_wrap_Geometry_AddGeometry,NULL)
 SWIG_ZEND_NAMED_FE(clone,_wrap_Geometry_Clone,NULL)
 SWIG_ZEND_NAMED_FE(getgeometrytype,_wrap_Geometry_GetGeometryType,NULL)
 SWIG_ZEND_NAMED_FE(getgeometryname,_wrap_Geometry_GetGeometryName,NULL)
 SWIG_ZEND_NAMED_FE(getarea,_wrap_Geometry_GetArea,NULL)
 SWIG_ZEND_NAMED_FE(getpointcount,_wrap_Geometry_GetPointCount,NULL)
 SWIG_ZEND_NAMED_FE(getx,_wrap_Geometry_GetX,NULL)
 SWIG_ZEND_NAMED_FE(gety,_wrap_Geometry_GetY,NULL)
 SWIG_ZEND_NAMED_FE(getz,_wrap_Geometry_GetZ,NULL)
 SWIG_ZEND_NAMED_FE(getpoint,_wrap_Geometry_GetPoint,NULL)
 SWIG_ZEND_NAMED_FE(getpoint_2d,_wrap_Geometry_GetPoint_2D,NULL)
 SWIG_ZEND_NAMED_FE(getgeometrycount,_wrap_Geometry_GetGeometryCount,NULL)
 SWIG_ZEND_NAMED_FE(setpoint,_wrap_Geometry_SetPoint,NULL)
 SWIG_ZEND_NAMED_FE(setpoint_2d,_wrap_Geometry_SetPoint_2D,NULL)
 SWIG_ZEND_NAMED_FE(getgeometryref,_wrap_Geometry_GetGeometryRef,NULL)
 SWIG_ZEND_NAMED_FE(getboundary,_wrap_Geometry_GetBoundary,NULL)
 SWIG_ZEND_NAMED_FE(convexhull,_wrap_Geometry_ConvexHull,NULL)
 SWIG_ZEND_NAMED_FE(buffer,_wrap_Geometry_Buffer,NULL)
 SWIG_ZEND_NAMED_FE(intersection,_wrap_Geometry_Intersection,NULL)
 SWIG_ZEND_NAMED_FE(union,_wrap_Geometry_Union,NULL)
 SWIG_ZEND_NAMED_FE(difference,_wrap_Geometry_Difference,NULL)
 SWIG_ZEND_NAMED_FE(symmetricdifference,_wrap_Geometry_SymmetricDifference,NULL)
 SWIG_ZEND_NAMED_FE(distance,_wrap_Geometry_Distance,NULL)
 SWIG_ZEND_NAMED_FE(empty,_wrap_Geometry_Empty,NULL)
 SWIG_ZEND_NAMED_FE(isempty,_wrap_Geometry_IsEmpty,NULL)
 SWIG_ZEND_NAMED_FE(isvalid,_wrap_Geometry_IsValid,NULL)
 SWIG_ZEND_NAMED_FE(issimple,_wrap_Geometry_IsSimple,NULL)
 SWIG_ZEND_NAMED_FE(isring,_wrap_Geometry_IsRing,NULL)
 SWIG_ZEND_NAMED_FE(intersect,_wrap_Geometry_Intersect,NULL)
 SWIG_ZEND_NAMED_FE(equal,_wrap_Geometry_Equal,NULL)
 SWIG_ZEND_NAMED_FE(disjoint,_wrap_Geometry_Disjoint,NULL)
 SWIG_ZEND_NAMED_FE(touches,_wrap_Geometry_Touches,NULL)
 SWIG_ZEND_NAMED_FE(crosses,_wrap_Geometry_Crosses,NULL)
 SWIG_ZEND_NAMED_FE(within,_wrap_Geometry_Within,NULL)
 SWIG_ZEND_NAMED_FE(contains,_wrap_Geometry_Contains,NULL)
 SWIG_ZEND_NAMED_FE(overlaps,_wrap_Geometry_Overlaps,NULL)
 SWIG_ZEND_NAMED_FE(transformto,_wrap_Geometry_TransformTo,NULL)
 SWIG_ZEND_NAMED_FE(transform,_wrap_Geometry_Transform,NULL)
 SWIG_ZEND_NAMED_FE(getspatialreference,_wrap_Geometry_GetSpatialReference,NULL)
 SWIG_ZEND_NAMED_FE(assignspatialreference,_wrap_Geometry_AssignSpatialReference,NULL)
 SWIG_ZEND_NAMED_FE(closerings,_wrap_Geometry_CloseRings,NULL)
 SWIG_ZEND_NAMED_FE(flattento2d,_wrap_Geometry_FlattenTo2D,NULL)
 SWIG_ZEND_NAMED_FE(getenvelope,_wrap_Geometry_GetEnvelope,NULL)
 SWIG_ZEND_NAMED_FE(centroid,_wrap_Geometry_Centroid,NULL)
 SWIG_ZEND_NAMED_FE(wkbsize,_wrap_Geometry_WkbSize,NULL)
 SWIG_ZEND_NAMED_FE(getcoordinatedimension,_wrap_Geometry_GetCoordinateDimension,NULL)
 SWIG_ZEND_NAMED_FE(setcoordinatedimension,_wrap_Geometry_SetCoordinateDimension,NULL)
 SWIG_ZEND_NAMED_FE(getdimension,_wrap_Geometry_GetDimension,NULL)
 { NULL, NULL, NULL}
};
...
if (! (ptr_ce_swig_Driver=zend_register_internal_class_ex(&ce_swig_Driver,NULL,NULL TSRMLS_CC))) zend_error(E_ERROR,"Error registering wrapper for class Driver");
...
if (! (ptr_ce_swig_DataSource=zend_register_internal_class_ex(&ce_swig_DataSource,NULL,NULL TSRMLS_CC))) zend_error(E_ERROR,"Error registering wrapper for class DataSource");

/* Define class Layer */
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_Layer,"layer",Layer_functions,NULL,_wrap_propget_Layer,_wrap_propset_Layer);
if (! (ptr_ce_swig_Layer=zend_register_internal_class_ex(&ce_swig_Layer,NULL,NULL TSRMLS_CC))) zend_error(E_ERROR,"Error registering wrapper for class Layer");
...
if (! (ptr_ce_swig_Feature=zend_register_internal_class_ex(&ce_swig_Feature,NULL,NULL TSRMLS_CC))) zend_error(E_ERROR,"Error registering wrapper for class Feature");
...
if (! (ptr_ce_swig_FeatureDefn=zend_register_internal_class_ex(&ce_swig_FeatureDefn,NULL,NULL TSRMLS_CC))) zend_error(E_ERROR,"Error registering wrapper for class FeatureDefn");
...
if (! (ptr_ce_swig_FieldDefn=zend_register_internal_class_ex(&ce_swig_FieldDefn,NULL,NULL TSRMLS_CC))) zend_error(E_ERROR,"Error registering wrapper for class FieldDefn");
...
if (! (ptr_ce_swig_Geometry=zend_register_internal_class_ex(&ce_swig_Geometry,NULL,NULL TSRMLS_CC))) zend_error(E_ERROR,"Error registering wrapper for class Geometry");
...
/* cinit subsection */
SWIG_LONG_CONSTANT(wkb25Bit, wkb25DBit);
