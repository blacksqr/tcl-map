...
/*
  ...
  call-seq:
    copy_data_source(DataSource copy_ds, char name, char options=0) -> DataSource
...
/*
  ...
  call-seq:
    open(char name, int update=0) -> DataSource
...
/*
  ...
  call-seq:
    Feature.new(FeatureDefn feature_def=0)
...
/*
  ...
  call-seq:
    open_shared(char filename, int update=0) -> DataSource
...
SWIGEXPORT void Init_ogr(void) {
  ...
  rb_define_method(cLayer.klass, "get_geometry_column", VALUEFUNC(_wrap_Layer_get_geometry_column), -1);
  rb_define_method(cLayer.klass, "get_fidcolumn", VALUEFUNC(_wrap_Layer_get_fidcolumn), -1);
  ...
  rb_define_method(cLayer.klass, "get_features_read", VALUEFUNC(_wrap_Layer_get_features_read), -1);
  ...
  rb_define_method(cFeature.klass, "get_field_as_date_time", VALUEFUNC(_wrap_Feature_get_field_as_date_time), -1);
  rb_define_method(cFeature.klass, "get_field_as_integer_list", VALUEFUNC(_wrap_Feature_get_field_as_integer_list), -1);
  rb_define_method(cFeature.klass, "get_field_as_double_list", VALUEFUNC(_wrap_Feature_get_field_as_double_list), -1);
  rb_define_method(cFeature.klass, "get_field_as_string_list", VALUEFUNC(_wrap_Feature_get_field_as_string_list), -1);
  ...
  rb_define_method(cFeature.klass, "set_field_integer_list", VALUEFUNC(_wrap_Feature_set_field_integer_list), -1);
  rb_define_method(cFeature.klass, "set_field_double_list", VALUEFUNC(_wrap_Feature_set_field_double_list), -1);
  rb_define_method(cFeature.klass, "set_field_string_list", VALUEFUNC(_wrap_Feature_set_field_string_list), -1);
  ...
  rb_define_method(cGeometry.klass, "export_to_kml", VALUEFUNC(_wrap_Geometry_export_to_kml), -1);
  rb_define_method(cGeometry.klass, "export_to_json", VALUEFUNC(_wrap_Geometry_export_to_json), -1);
  rb_define_method(cGeometry.klass, "add_point", VALUEFUNC(_wrap_Geometry_add_point), -1);
  rb_define_method(cGeometry.klass, "add_point_2d", VALUEFUNC(_wrap_Geometry_add_point_2d), -1);
  ...
  rb_define_method(cGeometry.klass, "get_point", VALUEFUNC(_wrap_Geometry_get_point), -1);
  rb_define_method(cGeometry.klass, "get_point_2d", VALUEFUNC(_wrap_Geometry_get_point_2d), -1);
  ...
  rb_define_method(cGeometry.klass, "set_point_2d", VALUEFUNC(_wrap_Geometry_set_point_2d), -1);
  ...
  rb_define_method(cGeometry.klass, "is_empty", VALUEFUNC(_wrap_Geometry_is_empty), -1);
  rb_define_method(cGeometry.klass, "is_valid", VALUEFUNC(_wrap_Geometry_is_valid), -1);
  rb_define_method(cGeometry.klass, "is_simple", VALUEFUNC(_wrap_Geometry_is_simple), -1);
  rb_define_method(cGeometry.klass, "is_ring", VALUEFUNC(_wrap_Geometry_is_ring), -1);
